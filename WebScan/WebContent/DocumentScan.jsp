...
<div id="DWTcontainer" class="body_Broad_width" style="background-color:#ffffff; height:850px; border:0;">
...
<div id="divComments" class="divinput" style="position:relative">
<ul>
<li><img alt="arrow" src="Images/arrow.gif" width="9" height="12"/><b>Comments</b></li>
 <li style="padding-left:9px;"><textarea rows="4" cols="30"  id="commentstxtid"></textarea>
 </li>
 </ul>
</div>
